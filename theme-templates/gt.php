	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
            ...
            <td align="left" valign="top" width="542" class="full-width" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif;">
							<div id="logo" style="display: block;"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/theme-images/cahnrs-logo.png" width="317" height="75" alt="WSU's College of Agricultural, Human, and Natural Resource Sciences" style="color: #fff; display: block; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 9px; height: 75px; max-width: 317px; width: 317px;" /></div>
							<img id="header" src="<?php bloginfo( 'stylesheet_directory' ); ?>/theme-images/gt-header.png" width="542" height="115" alt="Green Times" style="color: #fff; display: block; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 30px; height: 115px; max-width: 542px; width: 542px;" />
						</td>
            <td align="center" valign="top" width="208" class="full-width">
							...
							<table align="center" bgcolor="#b0aa1f" border="0" cellspacing="0" cellpadding="20" height="170" width="168" id="social">
  							<tr>
									<td align="center" width="50%" style="padding-bottom: 10px; padding-right: 0;">
										<a href="https://www.facebook.com/CAHNRS" title="Follow us on Facebook" style="color: #fff;"><img align="center" src="<?php bloginfo( 'stylesheet_directory' ); ?>/theme-images/newsletter-social-facebook.png" width="35" height="35" alt="Follow us on Facebook" style="display: block; height: 35px; margin: 0 auto; max-width: 35px; width: 35px;" /></a>
									</td>
                  <td align="center" width="50%" style="padding-bottom: 10px; padding-left: 0;">
                  	...
                  	<span style="color: #fff; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 16px; line-height: 20px;">SUSTAINABILITY FROM THE GROUND UP</span>
									</td>
							  </tr>
							</table>
    				...
    				<td align="center" width="750" class="full-width">
                  	...
                  	<span style="color: #555; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 12px;"><strong>Enjoy all three monthly newsletters from CAHNRS!</strong><br />
            				...
            				<br />
										...
										Viticulture and enology for Washington's world-class wine industry. <a href="http://wsu.us5.list-manage.com/subscribe?u=3cd4b2a328519c34e51f46c1d&id=a3e4964764" style="color: #b0aa1f; outline: none; text-decoration: none;">Subscribe here &raquo;</a></span>
									</td>
  							</tr>
							</table>
          	</td>
		...
		<tr>
            ...
            <td align="center">
            	<span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 12px;">
								<span style="color: #fff;">If you have comments or questions about a story, please <a href="mailto:kantors@wsu.edu" style="color: #b0aa1f; outline: none; text-decoration: none;">contact us</a>. Thank you for reading <a href="http://cahnrs.wsu.edu/blog/category/green-times/" style="color: #b0aa1f; outline: none; text-decoration: none;">Green Times</a>.</span><br />
								<br />
