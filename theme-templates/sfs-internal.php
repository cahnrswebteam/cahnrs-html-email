<center>
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  	...
  	<tr>
    	<td align="center">
				<!-- BEGIN FOOTER -->
				<table align="center" bgcolor="#363637" border="0" cellspacing="0" cellpadding="20" width="750" class="full-width" style="color: #b5babe; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 12px;">
  				<tr>
    				<td align="center">
          		<table align="center" width="100%" border="0" cellspacing="0" cellpadding="20">
  							<tr>
    							<td align="center" width="50%" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 10px; padding: 0 10px 20px 10px;">
                  	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/theme-images/sfs-wsu-logo.png" width="170" height="104" alt="Washington State University" style="color: #fff; display: block; height: 104px; margin: 0 auto; max-width: 170px; width: 170px;" />
							...
							<span style="color: #b5babe; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, san-serif; font-size: 12px;"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/theme-images/sfs-fb-icon.png" width="20" height="20" alt="FB" style="height: 20px; margin-right: 5px; max-width: 20px; width: 20px; vertical-align: text-bottom;" /> Stay Connected: <a href="https://www.facebook.com/SchoolofFoodScienceUIWSU" style="color: #d7b258; font-weight: bold; outline: none; text-decoration: none;">School of Food Science UI WSU</a><br />
            	<br />
